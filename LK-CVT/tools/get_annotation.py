...
def main():
    classes_path    = '/home/UserData/les/Awesome-Backbones-main/heart_section/2classes/2classes.txt'
    datasets_path   = '/home/UserData/les/Awesome-Backbones-main/heart_section/2classes'
    datasets        = ['train', 'test']
    classes, indexs = get_info(classes_path)
    
    for dataset in datasets:
        txt_file = open(datasets_path + '/' + dataset + '.txt', 'w')
