...
def main():
    ...
    parser.add_argument('path', default= '/home/UserData/les/Awesome-Backbones-main/datasets/batch_test',  help='Path of batch images')
    parser.add_argument('config', default='/home/UserData/les/Awesome-Backbones-main/models/tinyvit/tinyvit_21m.py', help='Config file')
    parser.add_argument(
        '--classes-map', default='/home/UserData/les/Awesome-Backbones-main/datas/annotations.txt', help='classes map of datasets')
    parser.add_argument(
        '--device', default='cpu', help='Device used for inference')
    parser.add_argument(
        '--save-path', default='/home/UserData/les/Awesome-Backbones-main/test/result',
