...
def main():
    ...
    split_rate = 0.2
    init_dataset = '/home/UserData/les/Awesome-Backbones-main/图像质量差的四腔心切面与五类非四腔心切面/6classes'
    new_dataset = '/home/UserData/les/Awesome-Backbones-main/图像质量差的四腔心切面与五类非四腔心切面/split_data/6classes'
    random.seed(0)
